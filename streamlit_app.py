...
st.write(
    ...
    Check out the tables and charts below and filter on the side to learn more about the projects and the United Nations Sustainable Development Goals (SDGs) they fulfill.
    
    **To start, please select your desired location(s) on the side to view their associated projects**
    
    If you would like to learn more about each registry, please navigate to their respective websites:
    
    [ACR Carbon (ACR)](https://acrcarbon.org/acr-registry/)\n
    [Verified Carbon Standard (VERRA)](https://registry.verra.org/app/search/VCS)\n
    [Climate Action Reserve (CAR)](https://thereserve2.apx.com/mymodule/mypage.asp)\n
    [IHS Markit (MRK) - now part of S&P Global](https://www.spglobal.com/commodityinsights/en/ci/products/environmental-registry.html)    
...
df = load_data("data/all_Markets.csv")
...
st.write(
    """
    The following bar graph shows the distribution of SDGs per registry.
